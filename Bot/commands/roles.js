...
module.exports = {
  name: 'roles',
  description: 'teste de roles reaction',
  // guildOnly: true,
  usage: 'dont have any',
  aliases: ['rola', 'roll'],
  // args: true,
  execute(client, message) {
      ...
      const a = message.guild.roles.get('693658072203395173'); // a role
      const b = message.guild.roles.get('693658096991600651'); // b role
      const c = message.guild.roles.get('693658114032926770'); // c role
